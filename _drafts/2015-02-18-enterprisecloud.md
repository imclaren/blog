---
layout: post
title: Cloud providers with terrible contracts leave millions on the table
---

*Immature cloud providers smash their standard contract terms and conditions through the bureaucracy of enterprise customers.  But mature cloud providers sell more services (and make more money) by negotiating "real" contracts with enterprise customers.*
...
I couldn't agree more (other than "mouthpiecing" - I don't think that's a word - but anyway).  Your cloud sales consultant will tell you that in the [new Agile world](http://iainmclaren.com/2015/01/28/agile/) customers should sign whatever ludicrous terms and conditions are placed in front of them.  

That is a fallacy.  Large enterprise customers will continue to favour service providers that are willing to sign contracts that are worth the paper that they are written on.  As Mark says:
...
### 2. Cloud sales executives can close more deals by challenging their internal teams to sign "real" contracts

In order to sell cloud services, Mark argues that there are three things that every enterprise customer wants to know: 

1. Why should I do anything?
2. Why your solution (vs. your competitors’)?
3. Why now (vs. investing in another area of our business)?

I think that is true, but I have found that a large number of enterprise customers already have satisfying answers to these questions.  In my experience, the problem that customers face is that suppliers didn't previously seriously argue that suppliers should take little or no legal responsibility for the services that they provide to enterprise customers. 

Large enterprise customers actually expect that externally hosted (i.e. cloud) services will be provided under terms and conditions that require those suppliers to accept responsibility, in a contract, if their cloud service do not work.

### 3. Suppliers willing to pay for failure can make more enterprise sales and charge higher margins
...
The same thing is about to happen with cloud services.  Cloud service providers have moved up the value chain by moving from IaaS to PaaS to SaaS:
...
But cloud providers are now differentiating themselves along another axis.  Enterprise customers will pay more for cloud provers that are willing to take responsibility, and move up the value chain, by signing terms and conditions that require them to take real responsibility for service failures. 

### 4. Enterprise customers pay handsomely for cloud services backed up by "real" terms and conditions
...
And enterprise customers will pay for this privilege.  Maybe suppliers that sign real contracts won't be swimming in gold coins like Scrooge McDuck.  But they won't be leaving millions of dollars on the table for their competition.
