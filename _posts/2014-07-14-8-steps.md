...
Then it hit me.  There are actually eight simple steps that we can follow if we want to quickly close contracts.  And then another client asked me to create a *"Markup and Document Exchange Protocol"* or a *"simple document to accompany initial drafts of agreement documents to establish ... preferred protocols."*

My clients are the best.  Really.  But that sounds awful.  I mean really awful.  Worse than doing my taxes awful.  So instead, let's just document these eight simple and practical steps:
